...
// Manta Specific Primitives
// adpated from https://github.com/AcalaNetwork/Acala/tree/master/primitives
...
use sp_runtime::{generic, MultiSignature, RuntimeDebug};
use sp_std::{
...
impl TryFrom<Vec<u8>> for CurrencyId {
	...
	fn try_from(v: Vec<u8>) -> Result<CurrencyId, ()> {
		match v.as_slice() {
			...
			b"MA" => Ok(CurrencyId::Token(TokenSymbol::MA)),
			_ => Err(()),
		}
	}
}
